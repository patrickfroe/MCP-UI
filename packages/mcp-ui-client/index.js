...
function AppRenderer(props) {
  return React.createElement(
    ...
    React.createElement('div', { style: { fontWeight: 600, marginBottom: 8 } }, 'AppRenderer Placeholder'),
    React.createElement('div', null, `resourceUri: ${props.resourceUri || ''}`),
    React.createElement('pre', { style: { fontSize: 12, overflow: 'auto' } }, props.resourceText || '')
  );
}
